//
//  OutsideTutorialTwoPageContentViewController.m
//  ProfWho
//
...
@interface OutsideTutorialTwoPageContentViewController ()

@end

@implementation OutsideTutorialTwoPageContentViewController
...
- (void)viewDidLoad {
    ...
    self.imageView.image = [UIImage imageNamed:@"ImageRec-3"];
}
