//
//  TutorialOnePageContentViewController.m
//  ProfWho
//
...
@interface TutorialOnePageContentViewController ()

@end

@implementation TutorialOnePageContentViewController
...
- (void)viewDidLoad {
    ...
    self.tutorialOneImageView.image = [UIImage imageNamed:@"Tutorial01"];
